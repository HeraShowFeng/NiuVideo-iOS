...
#define BUTTON_BACKGROUNDCOLOR NV_COLOR_RGBA(30, 30, 30, 0.8)
#define SELECTED_COLOR NV_COLOR_RGBA(60, 157, 191, 1)

@interface NVSegmentButtonView ()
...
@implementation NVSegmentButtonView
...
- (void)staticLabelClick:(UITapGestureRecognizer *)tap {
    ...
    if (self.rateDelegate != nil && [self.rateDelegate respondsToSelector:@selector(segmentButtonView:didSelectedTitleIndex:)]) {
        [self.rateDelegate segmentButtonView:self didSelectedTitleIndex:index];
